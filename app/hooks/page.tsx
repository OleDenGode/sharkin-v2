    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-4 md:p-6">
        ...
        <div className="bg-white rounded-lg shadow p-4 md:p-6 mb-6">
          <label className="block text-sm font-medium mb-2">Din kernidé, observation eller noter:</label>
          <textarea
            value={bulletPoints}
            onChange={(e) => setBulletPoints(e.target.value)}
            rows={5}
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder="Eks: Jeg har bemærket at de bedste ledere stiller flere spørgsmål end de giver svar..."
          />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
            ...
            <div>
              ...
              <input type="text" value={targetAudience} onChange={(e) => setTargetAudience(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Eks: Tech leads" />
            </div>
            <div>
              <label className="block text-sm font-medium mb-2">Formål</label>
              <input type="text" value={purpose} onChange={(e) => setPurpose(e.target.value)} className="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Eks: Thought leadership" />
            </div>
          </div>

          <button onClick={generateHooks} disabled={loading} className="w-full mt-6 bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 disabled:opacity-50 font-medium">
