        ...
        <div className="mb-20">
          <div className="mb-8">
            ...
            <p className="text-base text-slate-500 font-light">
              Indsæt posten du ønsker kommentarer til
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-3 gap-8 mt-8 pt-8 border-t border-slate-200">
              <div>
                <label className="block text-xs font-medium text-slate-700 uppercase mb-3 tracking-wide">
                  Sprog
                </label>
                <select
                  value={language}
        ...
        {result && (
          <div className="space-y-12">
            {result.post_analysis && (
              <div>
                <h3 className="text-xs font-medium text-slate-700 uppercase mb-3 tracking-wide">
                  Analyse
                </h3>
                <div className="bg-slate-50 border border-slate-200 rounded-2xl p-8">
                  <div>
                    <p className="text-xs text-slate-600 uppercase mb-2 tracking-wide">Budskab</p>
                    <p className="text-base text-slate-950 font-light mb-6">
                      {result.post_analysis.core_message}
                    </p>
                  </div>
            ...
            {result.comments && (
              <div>
                <h3 className="text-xs font-medium text-slate-700 uppercase mb-6 tracking-wide">
                  Dine 3 Strategier
                </h3>
                    ...
                    >
                      <div className="flex items-start justify-between mb-5">
                        <div className="flex-1">
                          <div
                            className={`inline-block px-3 py-1.5 bg-gradient-to-r ${getAngleColor(
                              comment.angle
                            )} text-white text-xs font-medium rounded-lg mb-3`}
                          >
                      ...
                      {expandedId === idx && (
                        <div className="pt-4 border-t border-slate-200">
                          <p className="text-xs text-slate-600 uppercase mb-2 tracking-wide">
                            Strategi
                          </p>
                          <p className="text-sm text-slate-700 font-light">
                            {comment.strategy_reasoning}
                          </p>
                        </div>
                      )}
