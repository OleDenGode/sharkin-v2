    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow p-4 md:p-6 mb-6">
          ...
          {!fromHook && (
            <>
              <label className="block text-sm font-medium mb-2">
                Hook (valgfrit - eller start fra idé nedenfor):
              </label>
              <textarea
                value={hook}
          ...
          <label className="block text-sm font-medium mb-2">
            {fromHook ? 'Ekstra kontekst eller noter (valgfrit):' : 'Din idé eller kernbudskab:'}
          </label>
          <textarea
            value={idea}
            ...
            placeholder={fromHook 
              ? "Tilføj ekstra kontekst, eksempler eller noter der skal med i posten..."
              : "Eks: Jeg har bemærket at de bedste ledere stiller flere spørgsmål end de giver svar..."
            }
          />
        ...
        {!fromHook && posts.length === 0 && (
          <div className="text-center mt-8 p-6 bg-gray-100 rounded-lg">
            ...
            <button
              ...
              className="px-6 py-2 bg-white border border-gray-300 hover:bg-gray-50 rounded-lg text-sm"
            >
